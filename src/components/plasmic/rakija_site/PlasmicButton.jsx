...
import sty from "./PlasmicButton.module.css"; // plasmic-import: CzIKnLukEYe/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: FQi4hgRb6pr/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: cuk0qwaJBss/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___0DgKi)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__q6Jxy)}
                role={"img"}
              />
            ),
