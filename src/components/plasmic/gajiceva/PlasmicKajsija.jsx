...
import sty from "./PlasmicKajsija.module.css"; // plasmic-import: zuhTsWioEe9/css
...
function PlasmicKajsija__RenderFunc(props) {
        ...
        >
          <NavigationBar
            ...
            brand={
              ...
              >
                ...
                >
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__axDaw)}
                    displayHeight={"40px"}
            ...
            closeButton={
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__pbPsh)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"none"}
                displayMinHeight={"0"}
            ...
            openButton={
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__tDgE6)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"none"}
                displayMinHeight={"0"}
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__wjRhr)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.column__rztOc)}>
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__ejp7W)}
                  displayHeight={"751px"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__flm3C)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.column__ftSg)}>
                <p.PlasmicImg
              ...
              <div className={classNames(projectcss.all, sty.column___0Weh8)}>
                {(
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? true
                    : true
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicKajsija__ArgProps,
          internalVariantPropNames: PlasmicKajsija__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicKajsija__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "parent") {
    func.displayName = "PlasmicKajsija";
  } else {
    func.displayName = `PlasmicKajsija.${nodeName}`;
  }
  return func;
}

export const PlasmicKajsija = Object.assign(
  // Top-level PlasmicKajsija renders the root element
  makeNodeComponent("parent"),
  {
    ...
    // Metadata about props expected for PlasmicKajsija
    internalVariantProps: PlasmicKajsija__VariantProps,
