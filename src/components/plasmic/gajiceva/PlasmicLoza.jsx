...
import sty from "./PlasmicLoza.module.css"; // plasmic-import: 8Ewm66OXjQH/css
...
import h8TDGnsN2XjpegPNzM3NFhW from "./images/h8TDGnsN2Xjpeg.jpg"; // plasmic-import: PNzM3NFhW/picture

export const PlasmicLoza__VariantProps = new Array();

export const PlasmicLoza__ArgProps = new Array();
...
function PlasmicLoza__RenderFunc(props) {
        ...
        >
          <NavigationBar
            ...
            brand={
              ...
              >
                ...
                >
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__rrMkN)}
                    displayHeight={"40px"}
            ...
            closeButton={
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__sYhsC)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"none"}
                displayMinHeight={"0"}
            ...
            openButton={
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__zhyKq)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"none"}
                displayMinHeight={"0"}
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__tMvqo)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.column__fPmQ)}>
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img___4TjuJ)}
                  displayHeight={"751px"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__qkPzB)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.column___1GNc0)}>
                <p.PlasmicImg
              ...
              <div className={classNames(projectcss.all, sty.column__oo5X0)}>
                {(
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? true
                    : true
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicLoza__ArgProps,
          internalVariantPropNames: PlasmicLoza__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicLoza__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "parent") {
    func.displayName = "PlasmicLoza";
  } else {
    func.displayName = `PlasmicLoza.${nodeName}`;
  }
  return func;
}

export const PlasmicLoza = Object.assign(
  // Top-level PlasmicLoza renders the root element
  makeNodeComponent("parent"),
  {
    ...
    // Metadata about props expected for PlasmicLoza
    internalVariantProps: PlasmicLoza__VariantProps,
